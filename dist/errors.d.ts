 ...
 */
export declare class FMSODataError extends Error {
 ...
 */
export declare class FMScriptError extends FMSODataError {
...
export declare function isFMSODataError(err: unknown): err is FMSODataError;
