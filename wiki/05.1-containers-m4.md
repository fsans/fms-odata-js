...
## Error Handling
Container operations follow the standard error flow of the library. If a request fails (e.g. 404 Not Found or 401 Unauthorized), the response is passed to `parseErrorResponse` to generate a typed `FMSODataError`.
